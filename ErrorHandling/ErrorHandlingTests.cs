...
public class ErrorHandlingTests
{
    ...
    {
        var successfulResult = ErrorHandling.HandleErrorWithOutParam("1", out var result);
    ...
    public void DisposableObjectsAreDisposedWhenThrowingAnException()
    {
        ...
        Assert.Throws<Exception>(() =>
            ErrorHandling.DisposableResourcesAreDisposedWhenExceptionIsThrown(disposableResource));
