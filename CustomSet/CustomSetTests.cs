...
public class CustomSetTests
{
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_empty_set_is_a_subset_of_another_empty_set()
    {
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_empty_set_is_a_subset_of_non_empty_set()
    {
        var set1 = new CustomSet();
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_non_empty_set_is_not_a_subset_of_empty_set()
    {
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_set_is_a_subset_of_set_with_exact_same_elements()
    {
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_set_is_a_subset_of_larger_set_with_same_elements()
    {
        var set1 = new CustomSet(1, 2, 3);
    ...
    [Fact]
    public void
        A_set_is_a_subset_if_all_of_its_elements_are_contained_in_the_other_set_set_is_not_a_subset_of_set_that_does_not_contain_its_elements()
    {
        var set1 = new CustomSet(1, 2, 3);
    ...
    [Fact]
    public void
        Intersection_returns_a_set_of_all_shared_elements_intersection_of_an_empty_set_and_non_empty_set_is_an_empty_set()
    {
        var set1 = new CustomSet();
    ...
    [Fact]
    public void
        Intersection_returns_a_set_of_all_shared_elements_intersection_of_a_non_empty_set_and_an_empty_set_is_an_empty_set()
    {
    ...
    [Fact]
    public void
        Intersection_returns_a_set_of_all_shared_elements_intersection_of_two_sets_with_no_shared_elements_is_an_empty_set()
    {
        var set1 = new CustomSet(1, 2, 3);
    ...
    [Fact]
    public void
        Intersection_returns_a_set_of_all_shared_elements_intersection_of_two_sets_with_shared_elements_is_a_set_of_the_shared_elements()
    {
        var set1 = new CustomSet(1, 2, 3, 4);
        var set2 = new CustomSet(3, 2, 5);
    ...
    [Fact]
    public void
        Difference_or_complement_of_a_set_is_a_set_of_all_elements_that_are_only_in_the_first_set_difference_of_two_empty_sets_is_an_empty_set()
    {
        var set1 = new CustomSet();
        var set2 = new CustomSet();
        var expected = new CustomSet();
    ...
    [Fact]
    public void
        Difference_or_complement_of_a_set_is_a_set_of_all_elements_that_are_only_in_the_first_set_difference_of_empty_set_and_non_empty_set_is_an_empty_set()
    {
        var set1 = new CustomSet();
        var set2 = new CustomSet(3, 2, 5);
        var expected = new CustomSet();
    ...
    [Fact]
    public void
        Difference_or_complement_of_a_set_is_a_set_of_all_elements_that_are_only_in_the_first_set_difference_of_a_non_empty_set_and_an_empty_set_is_the_non_empty_set()
    {
        var set1 = new CustomSet(1, 2, 3, 4);
        var set2 = new CustomSet();
        var expected = new CustomSet(1, 2, 3, 4);
    ...
    [Fact]
    public void
        Difference_or_complement_of_a_set_is_a_set_of_all_elements_that_are_only_in_the_first_set_difference_of_two_non_empty_sets_is_a_set_of_elements_that_are_only_in_the_first_set()
    {
    ...
    [Fact]
    public void
        Difference_or_complement_of_a_set_is_a_set_of_all_elements_that_are_only_in_the_first_set_difference_removes_all_duplicates_in_the_first_set()
    {
    ...
    [Fact]
    public void
        Union_returns_a_set_of_all_elements_in_either_set_union_of_an_empty_set_and_non_empty_set_is_the_non_empty_set()
    {
        var set1 = new CustomSet();
    ...
    [Fact]
    public void
        Union_returns_a_set_of_all_elements_in_either_set_union_of_a_non_empty_set_and_empty_set_is_the_non_empty_set()
    {
