...
public class CalculatorConundrumTests
{
    ...
    {
        Assert.Equal("378961 + 399635 = 778596",
            SimpleCalculator.Calculate(378_961, 399_635, "+"));
    }
    ...
    {
        Assert.Equal("72441 * 2048 = 148359168",
            SimpleCalculator.Calculate(72_441, 2_048, "*"));
    }
    ...
    {
        Assert.Equal("1338800 / 83675 = 16",
            SimpleCalculator.Calculate(1_338_800, 83_675, "/"));
    }
    ...
    public void Calculate_throws_exception_for_null_as_operation()
    {
        Assert.Throws<ArgumentNullException>(() =>
            SimpleCalculator.Calculate(1, 2, null!));
    }
    ...
    {
        Assert.Equal("Division by zero is not allowed.",
