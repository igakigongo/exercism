...
public class SimpleCipherTests
{
    ...
    public void Random_key_cipher_can_encode()
    {
        ...
        Assert.Equal(sut.Key[..10], sut.Encode("aaaaaaaaaa"));
    }
    ...
    {
        var sut = new SimpleCipher();
        Assert.Equal("aaaaaaaaaa", sut.Decode(sut.Key[..10]));
    }

    [Fact]
    public void
        Random_key_cipher_is_reversible_i_e_if_you_apply_decode_in_a_encoded_result_you_must_see_the_same_plaintext_encode_parameter_as_a_result_of_the_decode_method()
    {
        var sut = new SimpleCipher();
    ...
    [Fact]
    public void
        Substitution_cipher_is_reversible_i_e_if_you_apply_decode_in_a_encoded_result_you_must_see_the_same_plaintext_encode_parameter_as_a_result_of_the_decode_method()
    {
        var sut = new SimpleCipher("abcdefghij");
        Assert.Equal("abcdefghij", sut.Decode(sut.Encode("abcdefghij")));
    }
