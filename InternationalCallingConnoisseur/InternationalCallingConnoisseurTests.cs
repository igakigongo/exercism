...
public class InternationalCallingConnoisseurTests
{
    ...
    [Fact]
    public void
        Add_country_to_existing_dictionary_1_is_United_States_of_America()
    {
        var countryCodes = DialingCodes.AddCountryToExistingDictionary(
            DialingCodes.GetExistingDictionary(), 44, "United Kingdom");
    ...
    [Fact]
    public void
        Update_country_name_in_dictionary_for_non_existent_country_count_is_3()
    {
        var countryCodes = DialingCodes.UpdateDictionary(
    ...
    [Fact]
    public void
        Update_country_name_in_dictionary_for_non_existent_country_1_is_United_States_of_America()
    {
        var countryCodes = DialingCodes.UpdateDictionary(
            DialingCodes.GetExistingDictionary(), 999, "Newlands");
        Assert.Equal("United States of America", countryCodes[1]);
    ...
    [Fact]
    public void
        Update_country_name_in_dictionary_for_non_existent_country_55_is_Brazil()
    {
        var countryCodes = DialingCodes.UpdateDictionary(
            DialingCodes.GetExistingDictionary(), 999, "Newlands");
        Assert.Equal("Brazil", countryCodes[55]);
    ...
    [Fact]
    public void
        Update_country_name_in_dictionary_for_non_existent_country_91_is_India()
    {
        var countryCodes = DialingCodes.UpdateDictionary(
            DialingCodes.GetExistingDictionary(), 999, "Newlands");
        Assert.Equal("India", countryCodes[91]);
    ...
    [Fact]
    public void
        Remove_country_from_dictionary_for_non_existent_country_count_is_3()
    {
        var countryCodes = DialingCodes.RemoveCountryFromDictionary(
            DialingCodes.GetExistingDictionary(), 999);
        Assert.Equal(3, countryCodes.Count);
    ...
    [Fact]
    public void
        Remove_country_from_dictionary_for_non_existent_country_1_is_United_States_of_America()
    {
        var countryCodes = DialingCodes.RemoveCountryFromDictionary(
            DialingCodes.GetExistingDictionary(), 999);
        Assert.Equal("United States of America", countryCodes[1]);
    ...
    [Fact]
    public void
        Remove_country_from_dictionary_for_non_existent_country_55_is_Brazil()
    {
        var countryCodes = DialingCodes.RemoveCountryFromDictionary(
            DialingCodes.GetExistingDictionary(), 999);
        Assert.Equal("Brazil", countryCodes[55]);
    ...
    [Fact]
    public void
        Remove_country_from_dictionary_for_non_existent_country_91_is_India()
    {
        var countryCodes = DialingCodes.RemoveCountryFromDictionary(
            DialingCodes.GetExistingDictionary(), 999);
        Assert.Equal("India", countryCodes[91]);
    ...
    public void Longest_country_name()
    {
        ...
        var longestCountryName =
            DialingCodes.FindLongestCountryName(countryCodes);
