...
public class AtbashCipherTests
{
    ...
    public void Encode_deep_thought()
    {
        Assert.Equal("gifgs rhurx grlm",
            AtbashCipher.Encode("Truth is fiction."));
    }
    ...
    {
        Assert.Equal("testing123testing",
            AtbashCipher.Decode("gvhgr mt123 gvhgr mt"));
    }
    ...
    {
        Assert.Equal("anobstacleisoftenasteppingstone",
            AtbashCipher.Decode("zmlyhgzxovrhlugvmzhgvkkrmthglmv"));
    }
}
