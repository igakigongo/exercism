...
public class LogsLogsLogsTests
{
    ...
    public void Parse_trace()
    {
        Assert.Equal(LogLevel.Trace,
            LogLine.ParseLogLevel(
                "[TRC]: Line 84 - Console.WriteLine('Hello World');"));
    }
    ...
    public void Parse_debug()
    {
        Assert.Equal(LogLevel.Debug,
            LogLine.ParseLogLevel("[DBG]: ; expected"));
    }
    ...
    public void Parse_info()
    {
        Assert.Equal(LogLevel.Info,
            LogLine.ParseLogLevel("[INF]: Timezone changed"));
    }
    ...
    public void Parse_warning()
    {
        Assert.Equal(LogLevel.Warning,
            LogLine.ParseLogLevel("[WRN]: Timezone not set"));
    }
    ...
    public void Parse_fatal()
    {
        Assert.Equal(LogLevel.Fatal,
            LogLine.ParseLogLevel("[FTL]: Not enough memory"));
    }

    [Fact]
    public void Parse_unknown()
    {
        Assert.Equal(LogLevel.Unknown,
    ...
    {
        Assert.Equal("1:Line 13 - int myNum = 42;",
            LogLine.OutputForShortLog(LogLevel.Trace,
                "Line 13 - int myNum = 42;"));
    }
    ...
    public void Output_for_short_log_for_debug()
    {
        Assert.Equal(
            ...
            LogLine.OutputForShortLog(LogLevel.Debug,
    ...
    {
        Assert.Equal("4:File moved",
            LogLine.OutputForShortLog(LogLevel.Info, "File moved"));
    }

    [Fact]
    public void Output_for_short_log_for_warning()
    {
        Assert.Equal("5:Unsafe password",
    ...
    {
        Assert.Equal("42:Dumping all files",
    ...
    {
        Assert.Equal("0:Something unknown happened",
            LogLine.OutputForShortLog(LogLevel.Unknown,
