...
public class BirdWatcherTests
{
    ...
    {
        Assert.Equal(new[] { 0, 2, 5, 3, 7, 8, 4 }, BirdCount.LastWeek());
    }

    [Fact]
    public void Today_for_disappointing_day()
    {
        var counts = new[] { 0, 0, 1, 0, 0, 1, 0 };
    ...
    {
        var counts = new[] { 5, 9, 12, 6, 8, 8, 17 };
        var birdCount = new BirdCount(counts);
