...
public class BookingUpForBeautyTests
{
    ...
    {
        Assert.False(Appointment.HasPassed(DateTime.Now.AddYears(2).AddMonths(3)
            .AddDays(6)));
    }
    ...
    {
        Assert.False(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 6, 17, 8, 15,
                0)));
    }
    ...
    {
        Assert.False(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 2, 23, 11, 59,
                59)));
    }
    ...
    {
        Assert.True(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 8, 9, 12, 0,
                0)));
    }
    ...
    {
        Assert.True(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 9, 1, 17, 59,
                59)));
    }
    ...
    {
        Assert.False(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 9, 1, 18, 0,
                0)));
    }
    ...
    {
        Assert.False(
            Appointment.IsAfternoonAppointment(new DateTime(2019, 9, 1, 23, 59,
                59)));
    }
