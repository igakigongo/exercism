...
public class MeetupTests
{
    [Fact]
    public void
        When_teenth_monday_is_the_13th_the_first_day_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_monday_is_some_day_in_the_middle_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_tuesday_is_the_19th_the_last_day_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_tuesday_is_some_day_in_the_middle_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_tuesday_is_the_13th_the_first_day_of_the_teenth_week()
    {
        var sut = new Meetup(8, 2013);
    ...
    [Fact]
    public void
        When_teenth_wednesday_is_some_day_in_the_middle_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_wednesday_is_the_13th_the_first_day_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_wednesday_is_the_19th_the_last_day_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_thursday_is_some_day_in_the_middle_of_the_teenth_week()
    {
        var sut = new Meetup(5, 2013);
    ...
    [Fact]
    public void
        When_teenth_thursday_is_the_13th_the_first_day_of_the_teenth_week()
    {
        var sut = new Meetup(6, 2013);
    ...
    [Fact]
    public void
        When_teenth_thursday_is_the_19th_the_last_day_of_the_teenth_week()
    {
        var sut = new Meetup(9, 2013);
    ...
    [Fact]
    public void
        When_teenth_friday_is_some_day_in_the_middle_of_the_teenth_week()
    {
        var sut = new Meetup(8, 2013);
    ...
    [Fact]
    public void
        When_teenth_friday_is_the_13th_the_first_day_of_the_teenth_week()
    {
        var sut = new Meetup(9, 2013);
    ...
    [Fact]
    public void
        When_teenth_saturday_is_some_day_in_the_middle_of_the_teenth_week()
    {
        var sut = new Meetup(2, 2013);
    ...
    [Fact]
    public void
        When_teenth_saturday_is_the_13th_the_first_day_of_the_teenth_week()
    {
        var sut = new Meetup(4, 2013);
    ...
    [Fact]
    public void
        When_teenth_saturday_is_the_19th_the_last_day_of_the_teenth_week()
    {
    ...
    [Fact]
    public void
        When_teenth_sunday_is_some_day_in_the_middle_of_the_teenth_week()
    {
        var sut = new Meetup(6, 2013);
    ...
    [Fact]
    public void
        When_teenth_sunday_is_the_13th_the_first_day_of_the_teenth_week()
    {
        var sut = new Meetup(10, 2013);
    ...
    [Fact]
    public void
        When_first_wednesday_is_some_day_in_the_middle_of_the_first_week()
    {
    ...
    [Fact]
    public void
        When_first_thursday_is_some_day_in_the_middle_of_the_first_week()
    {
        var sut = new Meetup(9, 2013);
    ...
    [Fact]
    public void
        When_first_thursday_is_another_day_in_the_middle_of_the_first_week()
    {
        var sut = new Meetup(10, 2013);
    ...
    [Fact]
    public void
        When_first_saturday_is_some_day_in_the_middle_of_the_first_week()
    {
        var sut = new Meetup(1, 2013);
    ...
    [Fact]
    public void
        When_first_saturday_is_another_day_in_the_middle_of_the_first_week()
    {
        var sut = new Meetup(2, 2013);
    ...
    [Fact]
    public void
        When_second_monday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(3, 2013);
    ...
    [Fact]
    public void
        When_second_tuesday_is_the_14th_the_last_day_of_the_second_week()
    {
        var sut = new Meetup(5, 2013);
    ...
    [Fact]
    public void
        When_second_tuesday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(6, 2013);
    ...
    [Fact]
    public void
        When_second_wednesday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(7, 2013);
    ...
    [Fact]
    public void
        When_second_wednesday_is_the_14th_the_last_day_of_the_second_week()
    {
        var sut = new Meetup(8, 2013);
    ...
    [Fact]
    public void
        When_second_thursday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(9, 2013);
    ...
    [Fact]
    public void
        When_second_thursday_is_another_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(10, 2013);
    ...
    [Fact]
    public void
        When_second_friday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(12, 2013);
    ...
    [Fact]
    public void
        When_second_saturday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(1, 2013);
    ...
    [Fact]
    public void
        When_second_saturday_is_another_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(2, 2013);
    ...
    [Fact]
    public void
        When_second_sunday_is_some_day_in_the_middle_of_the_second_week()
    {
        var sut = new Meetup(3, 2013);
    ...
    [Fact]
    public void
        When_third_wednesday_is_some_day_in_the_middle_of_the_third_week()
    {
        var sut = new Meetup(7, 2013);
    ...
    [Fact]
    public void
        When_third_wednesday_is_the_21st_the_last_day_of_the_third_week()
    {
        var sut = new Meetup(8, 2013);
    ...
    [Fact]
    public void
        When_third_thursday_is_some_day_in_the_middle_of_the_third_week()
    {
        var sut = new Meetup(9, 2013);
        var expected = new DateTime(2013, 9, 19);
    ...
    [Fact]
    public void
        When_third_thursday_is_another_day_in_the_middle_of_the_third_week()
    {
        var sut = new Meetup(10, 2013);
    ...
    [Fact]
    public void
        When_third_saturday_is_some_day_in_the_middle_of_the_third_week()
    {
        var sut = new Meetup(1, 2013);
    ...
    [Fact]
    public void
        When_third_saturday_is_another_day_in_the_middle_of_the_third_week()
    {
        var sut = new Meetup(2, 2013);
        var expected = new DateTime(2013, 2, 16);
        Assert.Equal(expected, sut.Day(DayOfWeek.Saturday, Schedule.Third));
    ...
    [Fact]
    public void
        When_fourth_monday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(3, 2013);
    ...
    [Fact]
    public void
        When_fourth_monday_is_the_22nd_the_first_day_of_the_fourth_week()
    {
        var sut = new Meetup(4, 2013);
    ...
    [Fact]
    public void
        When_fourth_tuesday_is_the_28th_the_last_day_of_the_fourth_week()
    {
        var sut = new Meetup(5, 2013);
    ...
    [Fact]
    public void
        When_fourth_tuesday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(6, 2013);
    ...
    [Fact]
    public void
        When_fourth_wednesday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(7, 2013);
    ...
    [Fact]
    public void
        When_fourth_wednesday_is_the_28th_the_last_day_of_the_fourth_week()
    {
        var sut = new Meetup(8, 2013);
    ...
    [Fact]
    public void
        When_fourth_thursday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(9, 2013);
    ...
    [Fact]
    public void
        When_fourth_thursday_is_another_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(10, 2013);
    ...
    [Fact]
    public void
        When_fourth_friday_is_the_22nd_the_first_day_of_the_fourth_week()
    {
        var sut = new Meetup(11, 2013);
    ...
    [Fact]
    public void
        When_fourth_friday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(12, 2013);
    ...
    [Fact]
    public void
        When_fourth_saturday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(1, 2013);
    ...
    [Fact]
    public void
        When_fourth_saturday_is_another_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(2, 2013);
    ...
    [Fact]
    public void
        When_fourth_sunday_is_some_day_in_the_middle_of_the_fourth_week()
    {
        var sut = new Meetup(3, 2013);
    ...
    [Fact]
    public void
        Last_wednesday_in_december_that_is_also_the_last_day_of_the_year()
    {
    ...
    [Fact]
    public void
        When_last_sunday_in_february_in_a_non_leap_year_is_not_the_29th()
    {
